...
export const fetchCourseCategories = async () => {
  ...
  try {
    ...
    // Backend returns categories under `allCategorys`
...
export const createSection = async (data, token) => {
  ...
  try {
    ...
    // Backend returns the updated course under `updatedCourseDetails`
...
export const createSubSection = async (data, token) => {
  ...
  try {
    ...
    result = response?.data?.updatedSection || response?.data?.updatedSectionDetails || response?.data?.data
  } catch (error) {
...
export const updateSection = async (data, token) => {
  ...
  try {
    ...
    // Backend may return either updatedCourseDetails or data
    result = response?.data?.updatedCourseDetails || response?.data?.data || null
  } catch (error) {
...
export const deleteSection = async (data, token) => {
  ...
  try {
    ...
    // Some backends return updated course after deletion; prefer it if present
    result = response?.data?.updatedCourseDetails || response?.data?.data || null
  } catch (error) {
